...
// Avatar Component (same as dashboard)
const Avatar = ({ 
  src, 
  alt, 
  name, 
      ...
      <header className="bg-white border-b border-gray-200 fixed top-0 left-0 right-0 z-30">
        <div className="px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3 sm:gap-4">
            {user && (
              <div className="flex items-center gap-2">
                {/* Updated Avatar Component - Same as Dashboard */}
                <Avatar 
                  src={user.image} 
                  name={user.name} 
                  size="sm"
        ...
        >
          <div className="h-full overflow-y-auto">
            <nav className="p-4 space-y-1">
              <Link
                to="/user/dashboard"
                className={`flex items-center px-4 py-3 rounded-md transition-colors ${isActive('/user/dashboard')
              ...
              <Link
                to="/user/kpi-kra"
                className={`flex items-center px-4 py-3 rounded-md transition-colors ${isActive('/user/kpi-kra')
